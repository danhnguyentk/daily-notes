 ...
 * @param env Environment containing the SCRAPINGBEE_KEY
*/
export function buildScrapingBeeApiUrl(targetUrl: string, env: Env): string {
  return `https://app.scrapingbee.com/api/v1/?api_key=${env.SCRAPINGBEE_KEY}&url=${encodeURIComponent(targetUrl)}`;
}